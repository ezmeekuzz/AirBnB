...
class ReviewsforapprovalController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Reviews For Approval | Green Mountain Homes',
            ...
            'records' => $rresult,
            'activelink' => 'reviewsforapproval'
        ];
        return view('pages/admin/reviewsforapproval', $data);
    }
    ...
    public function approve($id)
    {
        ...
        $rModel = new ReviewsModel();
        $reviewId = $rModel->update($id, $data);
        $response = [
            'status' => 'success',
