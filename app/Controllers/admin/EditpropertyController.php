...
class EditpropertyController extends BaseController
{
    protected $bName = 'App\Models\admin\PropertiesModel';
    ...
    public function index($id)
    {
        ...
        $dresult = $dModel->where('property_id', $id)->findAll();

        $data = [
            'title' => 'Edit Property | Green Mountain Homes',
    ...
    public function update()
    {
        ...
        $propertyId = $propertyModel->update($property_id, $data);
        $response = [
            'status' => 'success',
